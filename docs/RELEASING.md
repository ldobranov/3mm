...
| `0.3.0-beta.9` / `v0.3.0-beta.9` | Beta | Prerelease |
...
For a tag such as `v0.3.0-beta.9`,
...
- `v0.3.0-beta.8` adds the scan handoff needed by a single Wi-Fi radio, the
  documented empty-database Beta login and corrected user management.
- `v0.3.0-beta.9` closes the physically accepted Raspberry baseline with
  repeatable clean-media installation, secret-free recovery prefill,
  audience-aware menus, restart and factory reset.
