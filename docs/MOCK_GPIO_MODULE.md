...
They exist for deterministic local acceptance. A real GPIO adapter and its
hardware permissions are separate Milestone 7 work.

## Manifest configuration

The module manifest declares inputs, initial output values, and local rules in
